...
class OutputContexts:
    ...
    # TODO add setter method for the name - study python classes!!!
    # def set_context_name(self, name):
    #     self.response["name"] = f'projects/{project_id}/agent/sessions/{session_id}/contexts/{context_name}'

    # TODO add a constructor from the string or the dictionary, to be used in the request.get_single_ouputcontext method
